...
spotify_anchor=(
  ...
  popup.height=150
  icon=􁁒
  icon.font="Hack Nerd Font:Regular:25.0"
  label.drawing=off
  drawing=off
  y_offset=2
)
...
spotify_title=(
  ...
  padding_right=0
  width=0
  label.font="Hack Nerd Font:Heavy:15.0"
  y_offset=55
)
...
spotify_state=(
  icon.drawing=on
  icon.font="Hack Nerd Font:Light Italic:10.0"
  icon.width=35
  icon="00:00"
  label.drawing=on
  label.font="Hack Nerd Font:Light Italic:10.0"
  label.width=35
  label="00:00"
  padding_left=0
  padding_right=0
